...
export default function Navbar(): React.JSX.Element {
    ...
    const navLinkClasses = "text-black hover:text-gray-900 transition-all font-semibold text-xl px-5 py-2.5 rounded-full bg-transparent border border-transparent hover:border-black";

    return (
        <header id="navbar" className="top-0 z-50 w-full bg-white">
            <div className="max-w-8xl mx-auto px-6 lg:px-10 h-24 flex items-center justify-between">
                {/* Logo */}
                <Link href="/" className="flex-shrink-0">
                    <Image
                        src={`${CDN_BASE}67a357657dfbded9b0b9da7c_buzz%20logo.svg`}
                        alt="Buzz Logo"
                        width={140}
                        height={38}
