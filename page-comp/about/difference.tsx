...
/* ================= Reusable text reveal blocks ================= */

/* Word-by-word scroll-linked color reveal */
...
/* Word-by-word rise-in-on-scroll */
...
/* ================= 3D tilt wrapper (mouse-tracking, hover) ================= */
/* Wrap any card in this to get a subtle depth tilt that follows the cursor,
   and settles back with an elastic-ish ease on mouse leave. */
const TiltCard = ({
    children,
    className = "",
    max = 8,
...
export default function WhoWeAreSec() {
            ...
            <div className="mx-auto w-full max-w-7xl relative z-10">
                ...
                <div className="mb-28 md:mb-36">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-16 items-end [transform-style:preserve-3d]">
                        <h2 className="depth-headline text-3xl sm:text-5xl md:text-6xl lg:text-[64px] font-normal leading-[1.15] tracking-tight text-zinc-950">
